...
operators char_to_operator(char op)
{
    ...
    case '!':
        return op_not;
    default:
        return error_op; // Invalid operator
    }
}
...
void set_current_type(int token)
{
    ...
    {
    case INT:
        current_declaration_type = TYPE_INT;
        break;
    case FLOAT:
        current_declaration_type = TYPE_FLOAT;
        break;
    case BOOL:
        current_declaration_type = TYPE_BOOL;
        break;
    case STRING:
        current_declaration_type = TYPE_STRING;
        break;
    case VOID:
        current_declaration_type = TYPE_VOID;
        break;
    default:
        current_declaration_type = TYPE_INT; // Default
    }
}
